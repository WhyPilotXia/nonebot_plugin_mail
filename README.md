...
本版本相比0.7.6增加群白名单功能。相比0.7.7：使用现代化插件配置。 相比0.7.10：寄信/智能寄信增加取消和多次错误自动取消。
...
- `/mail @某人`：查看联系人信息
- `/mail 修改 字段 内容`：修改自己的联系人信息，支持电话、电子邮箱、地址、邮编、QQ 等字段
- `/mail 我的寄件`：查看自己最近寄出的邮件记录
- `/mail 删除 编号 确认删除`：删除自己最近寄件列表中的记录
- /`寄信` / `寄件` / `寄出`：进入人工寄件登记流程
...
```text
/mail 修改 @某人 地址1 新地址
/mail 修改 页面ID 地址1 新地址
/mail 我的寄件 @某人
/mail 删除 @某人 1 确认删除
/mail 删除 Notion页面ID 确认删除
```

可修改字段：电话、电子邮箱、地址1、邮编1、地址2、邮编2、QQ。删除寄件记录时，普通用户只能删除自己寄出的记录；Notion API 中的删除会以归档页面实现。
