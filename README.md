...
在 NoneBot 2环境配置.env或.env.dev中设置：
  ...
  ### Notion 相关
   ...
   配置项                    必填    默认值              说明
  ━━━━━━━━━━━━━━━━━━━━━━━━  ━━━━━━  ━━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   NOTION_TOKEN              是      无                  Notion API 访问令牌，用于读取联系人表、写入邮件记录、签收邮件
                                                         记录。
  ────────────────────────  ──────  ──────────────────  ────────────────────────────────────────────────────────────────
   RAS_DATA_SOURCE_ID        是      31e70d82-c716-      邮件记录表的数据源 ID，用于查询邮件记录。
                                     80ba-b4d2-
                                     000b1892f62c
  ────────────────────────  ──────  ──────────────────  ────────────────────────────────────────────────────────────────
   CONTACT_DATA_SOURCE_ID    是      31e70d82-c716-      联系人表的数据源 ID，用于读取联系人信息。
                                     8034-b23d-
                                     000ba20878af
  ...
  ──────────────────────  ──────  ───────────────────────────  ────────────────────────────────────
   AI_API_KEY              是      无                           视觉识别接口的访问密钥。
  ──────────────────────  ──────  ───────────────────────────  ────────────────────────────────────
   AI_MODEL                是      Qwen3.6-Plus                 识别信封图片时使用的模型名称。
  ──────────────────────  ──────  ───────────────────────────  ────────────────────────────────────
  ...
  - `NOTION_TOKEN` 不填时，联系人表会尝试使用本地 fallback，但邮件查询、签收和提交 Notion 仍会受限
